...
#define CREATE_TEXT(text, size, font, color, x, y, txt_string) { text.setPosition(x, y); text.setFont(font); text.setCharacterSize(size); text.setFillColor(color); text.setString(txt_string); }