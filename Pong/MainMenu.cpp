...
void CMainMenu::LoadScene()
{
	...
	case CMainMenu::MAIN:
		//Create text's
		CREATE_TEXT(Scene_Menu_Ver_Text, 12, Default_Font, Color::White, 0, game->m_WindowHeight - 30.0f, "Version " + string(GAME_VERSION) +"\nGame by Antd23rus");
	...
	case CMainMenu::MODE_SELECTION:
		...
		CREATE_TEXT(Scene_Menu_Back_Text, 15, Default_Font, Color::White, game->m_WindowWidth - 190.0f, game->m_WindowHeight - 30.0f, "Esc - Back to Menu");
		break;
